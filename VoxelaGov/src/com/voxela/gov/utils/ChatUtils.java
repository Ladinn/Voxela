...
public class ChatUtils {
	...
	public static String divider = ChatColor.DARK_GRAY + "[" + ChatColor.STRIKETHROUGH + "----------------------------------------------------" + ChatColor.RESET + ChatColor.DARK_GRAY + "]";
	
	public static String formatTitle(String title) {

		String govLine = ChatColor.DARK_GRAY + "[" + ChatColor.DARK_GRAY + ChatColor.STRIKETHROUGH + "------------------------------------------------------------" + ChatColor.RESET + ChatColor.RESET + ChatColor.DARK_GRAY + "]";
		String taxLine = ChatColor.DARK_GRAY + "[" + ChatColor.DARK_GRAY + ChatColor.STRIKETHROUGH + "------------------------------------------------------------------" + ChatColor.RESET + ChatColor.RESET + ChatColor.DARK_GRAY + "]";
		String line;
		
		if (title.contains("Taxes")) {
			line = taxLine;
		} else {
			line = govLine;
		}
	...
	public static String fromUUID (String uuidString) {
	...
	public static UUID toUUID (String playerToGet) {
