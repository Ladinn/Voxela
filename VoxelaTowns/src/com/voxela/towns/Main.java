...
import com.voxela.towns.timeUtils.RentCheck;
...
public class Main extends JavaPlugin implements Listener {
	...
	public static String consolePrefix = "[Voxela Towns] ";
	public static String gamePrefix = ChatColor.DARK_GRAY + "[" + ChatColor.AQUA + "Voxela" + ChatColor.DARK_GRAY + "] ";
	
	@Override
	public void onEnable() {
		System.out.print(consolePrefix + "Towns has been enabled.");
		instance = this;
	...
	public void onDisable() {
		System.out.print(consolePrefix + "Towns has been disabled.");
